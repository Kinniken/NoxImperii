...
function create ()
   ...
   if p:exists() then
      ...
      if standing < 20 then
         mem.refuel_no = "\"My fuel is property of the Oligarchy.\""
   ...
   if rnd.rnd() > 0.7 then
     ...
     bribe_no = {
            ...
            "\"The Doge likes to make examples out of scum like you.\"",
...
function taunt ( target, offense )
   ...
   if offense then
      taunts = {
            ...
            "The Doge will enjoy your death!",
            "Your head will make a fine gift for the Doge!",
            "None survive the wrath of the Doge!",

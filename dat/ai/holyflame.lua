...
function create ()
   ...
   r = rnd.rnd(0,20)
   if r == 0 then
     ai.pilot():broadcast("Fear the light of the Flame.")
    elseif r == 1 then
      ai.pilot():broadcast("Let all cower before the Flame.")
   end
   ...
   if p:exists() then
      ...
      if standing < 20 then
         mem.refuel_no = "\"My fuel belongs to the Flame itself.\""
...
function taunt ( target, offense )
   ...
   if offense then
      taunts = {
            ...
            "Die, you royalist scum!",
            "For the Flame!"
      }
   else
      taunts = {
            "The Flame will protect me!",
            "I am ready to die defending the Flame.",
            "You shall not triumph, infidel!"
      }
   end

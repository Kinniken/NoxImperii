...
Passive outfits modify your ship some way, and are always in effect. Engine Reroutes, Generators, Armour and Fuel Pods are examples of passive outfits.

Activated outfits have three possible states they can be in: off, on and cool-down. While off or in cool-down, the outfit does nothing for you. It only weighs down your ship. When on, its effects are applied to your ship, and it will consume whatever resources it demands from your ship.]]
   message3 = [[In this tutorial, your ship has been equipped with a single Generic Jammer. This is an activated outfit that can help you evade incoming missiles, but only when it's active.
...
It is important to know that some activated outfits can remain on as long as you have the energy, while others will only stay on for a maximum amount of time. Also, some outfits will need to go through a cool-down period after shutting off, during which time you can't use them. When an outfit is in its cool-down period, you can look at its icon to see how far along it is.

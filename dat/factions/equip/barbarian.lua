...
function equip_military( p, shipsize )
   ...
   equip_fillTurretsBySlotSize(p:ship(),outfits,nbTurrets,equip_defaultTurretsBarbarians())
   equip_fillWeaponsBySlotSize(p:ship(),outfits,nbForwards,nbSecondaries,equip_defaultForwardBarbarians(),equip_defaultSecondaryBarbarians())

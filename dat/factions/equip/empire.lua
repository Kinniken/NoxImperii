...
function equip_military( p, shipsize )
   ...
   equip_fillTurretsBySlotSize(p:ship(),outfits,nbTurrets,equip_defaultTurretsEmpire())
   equip_fillWeaponsBySlotSize(p:ship(),outfits,nbForwards,nbSecondaries,equip_defaultForwardEmpire(),equip_defaultSecondaryEmpire())
   equip_fillUtilitiesBySlotSize(p:ship(),outfits,nbUtilities,equip_defaultUtilitiesEmpire())
   equip_fillStructuresBySlotSize(p:ship(),outfits,nbStructures,equip_defaultStructuresEmpire())

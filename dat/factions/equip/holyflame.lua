...
function equip_military( p, shipsize )
   ...
   equip_fillTurretsBySlotSize(p:ship(),outfits,nbTurrets,equip_defaultTurretsHolyFlame())
   equip_fillWeaponsBySlotSize(p:ship(),outfits,nbForwards,nbSecondaries,equip_defaultForwardHolyFlame(),equip_defaultSecondaryHolyFlame())

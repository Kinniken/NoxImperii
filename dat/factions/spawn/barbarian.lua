...
declare_fleet(function() return spawn_variableFleet({"Barbarian Raider",2,4}) end,10,{presence={nil,20,100,nil}})


declare_fleet(function() return spawn_variableFleet({"Barbarian Looter",1,1},{"Barbarian Raider",1,2}) end,10,{presence={20,50,nil,nil}})
declare_fleet(function() return spawn_variableFleet({"Barbarian Raptor",1,1},{"Barbarian Raider",1,2}) end,5,{presence={20,50,nil,nil}})

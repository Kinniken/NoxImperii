...
bar_accept_title = "Agent for the Empire"
...
bar_accept_text_extra = [["The mission is nothing complex. We just need you to fly through the following systems: ${targetSystem1}, ${targetSystem2}, ${targetSystem3} and ${targetSystem4}. Come back to this system and beam back the results."]]
  ...
  space_success_title = "An Unexpected Promotion"
  space_success_text = "You enter system ${startSystem} and transfer the data to the Navy base. Your payment of ${credits} cr is immediately wired. There is an unexpected postscript to the message: you've been raised to the rank of Reserve Lieutenant!"

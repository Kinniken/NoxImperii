...
include("pilot/pirate.lua")
   ...
   bar_success_text = [[Lieutenant Palacios waves as you enter the bar. "I've heard for ${targetShipName} - well done! Of course, the crew should have been captured and tried in court... but this is still justice of sort. And yes, I did manage to get you your ${credits} credits. Never thought I'd be one to fiddle my own unit's accounts. Anyway! Cheers to you, captain! What an officer you would have made! I might mention your services to other dedicated young officers... quietly, of course. Check your messages whenever you land!"

...
text[1] = [[As you enter the system, your ship automatically connects to the Imperial communication network. Along with the usual automated communications, a personal message flashes on your command center. "Dominic Flandry...", you mutter as you read the sender's identity. A cadet a year senior to you in navy school, brash and confidant, roguish but determined to shine in the Navy. He had graduated a year before and been deployed in some frontier world, you remember.
...
"An other thing - I'm posted on Starkad now, on the Merseian border. Check a map. We could use someone with your piloting skills and no official ties to the Imperial Navy. Be discreet. And bring a bottle of brandy. The navy mess is out of everything drinkable."
...
title[2] = "Highport Outpost"
text[2] = [[You land at Highport, the small military outpost maintained by the Empire at the top of Mount Narpa, twelve kilometers above sea level, where the air is breathable by humans. Flandry is waiting for you, proudly wearing a spotless Lieutenant uniform - though with a cap more rakishly angled than regulations permit.

He gratefully accept the bottle of brandy you are carrying and take you to a quiet table in the nearby mess. "Let me give you the low down on this place... it might take a while.", he starts. It's a long discussion, but the core of it is simple: the Empire had long established a small outpost on Highport, from which to monitor activity in the area, as well as friendly but limited relations with the nearby city of Toborko land dwellers. Despite the world's remoteness from the Roidhunate's borders and little strategic relevance, Merseia secretly setup an underwater base in an other ocean and initiated relations with the world's other sentient specie, the sea-bottom-dwelling Seatrolls. Local quarrels between the two species were now steadily escalating into serious conflicts, with each Empire supplying weapons, technical help and increasing numbers of "instructors" to their client race.

The rest of Flandry's ramblings feel almost like fantasy - especially the part on how he was shot over the ocean, rescued by a Toborko ship before helping save it from an attack by the Seatrolls, and in typical Flandry faction, how the female captain fell for him, all alien that she was.

"The worse part is that we have no idea why we are fighting here. This world simply isn't worth it. But the greentails are trying to force us out, so we're resisting, see what I mean?" Flandry adds, sipping what is left of the brandy. "But without escalating too much either - they don't seem to want open war and we certainly don't.". He reclines, letting go of the empty glass. "Now, as to where you come in... I need you to meet Commander Abrams. He's the head honcho here. I recommended you to him, so be sharp, ok?"]]

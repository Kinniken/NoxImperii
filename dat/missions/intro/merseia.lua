...
misn_desc = "Take the student to Merseia."

-- OSD
OSDtitle = "Student on a Scholarship"
OSDdesc = "Go to Merseia in the Koiych system with the student."
OSDtable = {}
...
finishedtxt = [[    "Incredible! Merseia itself. I feel like an American in Moscow in say 1960. Sorry, pre-spatial reference... Anyway. Before I leave, one last tip: Merseian Telloch sells very well on Terra and other rich Imperial worlds. You'll only get good one here, so stock up. And here are the %s credits from the grant. Not much, I know... university budgets are not what they used to be."]]
...
function accept ()
   if not tk.yesno( title[1], text[1] ) then
      ...
      landmarker = misn.markerAdd( planet.get("Merseia"):system(), "low" )
...
function land ()
   if planet.cur() == planet.get("Merseia") then

...
moonTemplateVolcanicLife={spacePicts={"moon-P00.png"},exteriorPicts={"ln/mountain_ice.png"},minRadius=800,maxRadius=1000,descGenerator=descModule.moonJovianVolcanicLifeDesc,possibleNatives=natives_generator.lavaOasisNatives,typeName="moonVolcanicLife",classification="Volcanic Oasis Moon",mass={0.1,0.3},planetRadius={0.1,0.3},nativeFertility={0.5,0.8},humanFertility={0.3,0.6},minerals={0.5,1}}

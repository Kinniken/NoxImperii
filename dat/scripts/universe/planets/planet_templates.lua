...
--terrestoid planets
local planetTemplateMercury={spacePicts={"A00.png","A01.png"},exteriorPicts={"lava.png"},minRadius=0.05,maxRadius=0.1,descGenerator=descModule.mercuryDesc,typeName="mercury",classification="B",mass={0.03,0.1},planetRadius={0.2,0.5},ua={0.25,0.5},temperature={380,500},dayLength={40,1000},yearLength={0.1,0.5},nativeFertility={0,0},humanFertility={0,0},minerals={0,0.15}}
local planetTemplateVenus={spacePicts={"C00.png","H00.png"},exteriorPicts={"lava.png"},minRadius=0.1,maxRadius=0.15,descGenerator=descModule.venusDesc,typeName="venus",classification="N",mass={0.5,2},planetRadius={0.7,2},ua={0.5,0.9},temperature={500,900},dayLength={40,1000},yearLength={0.4,0.8},nativeFertility={0,0},humanFertility={0,0},minerals={0,0.30}}
local planetTemplateJungleVenus={spacePicts={"M02.png","M04.png"},exteriorPicts={"forest.png"},minRadius=0.1,maxRadius=0.15,descGenerator=descModule.jungleVenusDesc,possibleNatives=natives_generator.warmTerranNatives,typeName="jungleVenus",classification="L",mass={0.5,1.2},planetRadius={0.7,1.2},ua={0.5,0.9},temperature={300,320},dayLength={40,1000},yearLength={0.4,0.8},nativeFertility={0.60,1.20},humanFertility={0,0.25},minerals={0.10,0.50}}
local planetTemplateWarmTerra={spacePicts={"M05.png","M04.png"},exteriorPicts={"oceanic2.png"},minRadius=0.2,maxRadius=0.25,descGenerator=descModule.warmTerraDesc,possibleNatives=natives_generator.warmTerranNatives,typeName="warmTerra",classification="M",mass={0.9,1.1},planetRadius={0.8,1.2},ua={0.9,1.2},temperature={292,297},dayLength={0.5,3},yearLength={0.7,2},nativeFertility={0.60,1.00},humanFertility={0.50,0.70},minerals={0.5,1.5}}
local planetTemplateTemperateTerra={spacePicts={"M00.png","M01.png","M02.png","M03.png","M04.png","M05.png","M06.png","M07.png","M08.png","M09.png","M10.png","M11.png"},exteriorPicts={"oceanic.png","oceanic2.png","forest.png","forest2.png"},minRadius=0.2,maxRadius=0.25,descGenerator=descModule.temperateTerraDesc,possibleNatives=natives_generator.temperateTerranNatives,typeName="temperateTerra",classification="M",mass={0.9,1.1},planetRadius={0.8,1.2},ua={0.9,1.2},temperature={280,292},dayLength={0.8,1.3},yearLength={0.7,2},nativeFertility={0.60,1.40},humanFertility={0.70,1.10},minerals={0.5,1.5}}
local planetTemplateColdTerra={spacePicts={"P00.png","P01.png","P02.png","P03.png","P04.png","P05.png"},exteriorPicts={"snow.png"},minRadius=0.2,maxRadius=0.25,descGenerator=descModule.coldTerraDesc,possibleNatives=natives_generator.coldTerranNatives,typeName="coldTerra",classification="M",mass={0.9,1.1},planetRadius={0.8,1.2},ua={0.9,1.2},temperature={270,280},dayLength={0.5,2},yearLength={0.7,2},nativeFertility={0.40,0.80},humanFertility={0.50,0.70},minerals={0.5,1.5}}
local planetTemplateMars={spacePicts={"K00.png","K02.png","K03.png","K04.png"},exteriorPicts={"desertic.png"},minRadius=0.3,maxRadius=0.35,descGenerator=descModule.marsDesc,typeName="mars",classification="K",mass={0.5,1.0},planetRadius={0.5,1},ua={1.4,1.6},temperature={190,240},dayLength={0.5,2},yearLength={1.5,3},nativeFertility={0.0,0.2},humanFertility={0,0},minerals={0.5,1.5}}

--gas giants
local planetHotJupiter={spacePicts={"J06.png","J08.png"},exteriorPicts={"methane.png"},minRadius=0.005,maxRadius=0.25,descGenerator=descModule.hotJupiterDesc,typeName="hotJupiter",classification="J",mass={50,500},planetRadius={5,10},ua={0.25,0.7},temperature={400,800},dayLength={0.5,2},yearLength={1.5,3},nativeFertility={0,0},humanFertility={0,0},minerals={0,0}}

local planetJovian={spacePicts={"J00.png","J01.png","J02.png","J03.png","J04.png","J05.png","J07.png","J09.png"},exteriorPicts={"methane.png"},minRadius=0.3,maxRadius=0.6,descGenerator=descModule.jovianDesc,typeName="jovian",classification="J",mass={50,1000},planetRadius={5,10},ua={1.5,4},temperature={120,220},dayLength={0.3,2},yearLength={2,12},nativeFertility={0,0},humanFertility={0,0},minerals={0,0}}


local classMercury={{template=planetTemplateMercury,weight=1}}
local classVenus={{template=planetTemplateVenus,weight=5},{template=planetTemplateJungleVenus,weight=1}}
local classEarth={{template=planetTemplateWarmTerra,weight=1},{template=planetTemplateTemperateTerra,weight=1},{template=planetTemplateColdTerra,weight=1}}
local classMars={{template=planetTemplateMars,weight=1}}
local classHotJupiter={{template=planetHotJupiter,weight=1}}
local classJovian={{template=planetJovian,weight=1}}

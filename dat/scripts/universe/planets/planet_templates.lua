...
moonTemplateAsteroid={spacePicts={"asteroid-D00.png","asteroid-D01.png","asteroid-D02.png","asteroid-D03.png","asteroid-D04.png","asteroid-D05.png","asteroid-D06.png"},exteriorPicts={"ln/asteroid.png"},minRadius=300,maxRadius=400,descGenerator=descModule.moonAsteroidDesc,typeName="moonAsteroid",classification="Asteroid",mass={0.005,0.01},planetRadius={0.05,0.1},nativeFertility={0.0,0},humanFertility={0,0},minerals={0.2,0.5}}
moonTemplateRealMoon={spacePicts={"moon-C00.png","moon-C01.png","moon-D00.png","moon-D01.png"},exteriorPicts={"ln/barren_moon.png"},minRadius=400,maxRadius=500,descGenerator=descModule.moonWorldDesc,typeName="moonWorld",classification="Barren Telluric",mass={0.1,0.2},planetRadius={0.1,0.2},nativeFertility={0.0,0},humanFertility={0,0},minerals={0.5,1}}

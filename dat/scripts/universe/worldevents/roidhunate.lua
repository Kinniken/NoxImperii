...
event.weightValidity=function(planet)
	return (planet.c:faction()==faction.get("Roidhunate of Ardarshir") and planet.lua.settlements.natives and planet.lua.settlements.natives.stability<2)
end
event.weight=5
event.applyOnWorldCustom=function(self,planet,textData)
	...
	planet.lua.settlements.natives:addGoodDemand(BASIC_WEAPONS,20,3,effectId)
end

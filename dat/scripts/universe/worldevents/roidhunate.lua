...
event.weightValidity=function(planet)
	return (planet.c:faction()==faction.get("Roidhunate of Ardarshir") and planet.lua.settlements.natives and planet.lua.settlements.natives.stability<1)
end
event.weight=5

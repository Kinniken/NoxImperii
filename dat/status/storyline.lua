...
function getMissionsDesc()
  ...
  for _,missionName in ipairs(missionsIP) do
	...
	local desc="\027GMain Storyline:\0270\n\n"
  ...
  if (var.peek("harkan_empire_choice")) then    
    if doneIndex["Harkan Empire"]==8 then
      ...
      if ipIndex["Harkan Empire"]==0 then
        --6, 7 or 8
        desc=desc.." The next mission is available on Harkan."
      else
  ...
  elseif doneIndex["Intro"]==3 then
    ...
    if ipIndex["Intro"]==0 then
      ...
      elseif doneIndex["Intro"]==1 then
        desc=desc.." The next mission is available on "..var.peek("intro_2_planet").."."
      elseif doneIndex["Intro"]==2 then
        desc=desc.." The next mission is available on "..var.peek("intro_3_planet").."."
      end
    else
      desc=desc.." A mission is in progress."
    end
  ...
  --recurring
  desc=desc.."\n\n\027GEmpire rank:\0270 "..emp_getRank()
  ...
  desc=desc.."\n\n\027GRoidhunate rank:\0270 "..ardar_getRank()
  ...
  desc=desc.."\n\n\027GHoly Flame rank:\0270 "..holyflame_getRank()

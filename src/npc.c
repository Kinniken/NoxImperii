...
/**
 * @brief Minimum needed NPC data for crew.
 */
typedef struct NPCcrewData_ {
   Crew* crew;
   char *generatedName; /**< name of this specific crew instance */
} NPCcrewData;
...
void npc_generate (void)
{
   ...
   //And now the Crew ones
   crew_addToBar(land_planet);
